...
@Configuration
@ComponentScan
@EntityScan("Proiectmicroservices.demo.accounts")
@EnableJpaRepositories(basePackages = "Proiectmicroservices.demo.accounts")
@PropertySource("classpath:account-controller-tests.properties")
